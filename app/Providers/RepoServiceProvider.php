...
class RepoServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind('App\Repository\SettingRepositoryInterface', 'App\Repository\SettingRepository');
        $this->app->bind('App\Repository\TeacherQuizzRepositoryInterface', 'App\Repository\TeacherQuizzRepository');
    }
