 ...
 Main content -->
    ...
    <div class="content-wrapper">
        <div class="page-title" >
            <div class="row">
                <div class="col-sm-6" >
                    <h4 class="mb-0" style="font-family: 'Cairo', sans-serif">مرحبا بك : {{auth()->user()->Name}}</h4><br>
                </div>
                <div class="col-sm-6">
        ...
        <!-- widgets -->
        <div class="row" >
            <div class="col-xl-5 col-lg-6 col-md-6 mb-30">
        ...
        <div class="row">
            ...
            <div  style="height: 400px;" class="col-xl-10 mb-30">
                <div class="card card-statistics h-100">
                    <div class="card-body">
