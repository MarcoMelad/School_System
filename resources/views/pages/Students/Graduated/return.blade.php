    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{trans('Students_trans.student_recovery')}}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('Graduated.update','test')}}" method="post" autocomplete="off">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">{{trans('Students_trans.cancel_graduate')}}</h5>
